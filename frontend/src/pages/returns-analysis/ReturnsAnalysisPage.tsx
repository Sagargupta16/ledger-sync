...
import { TrendingUp, TrendingDown, Banknote, Receipt, Activity, AlertTriangle } from 'lucide-react'
import {
  XAxis, YAxis,
...
import {
  PageContainer, PageHeader, ChartContainer,
  BRUSH_DEFAULTS,
    ...
    return (
      <PageContainer className="md:space-y-6">
        ...
        <EmptyState
          ...
          description="We hit an error fetching your transactions and balances. Check your connection and try again."
          variant="card"
        />
      </PageContainer>
    )
